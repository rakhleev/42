---
layout: post
title:  "Терминал для смартфона"
date:   2021-07-24 3:20:00 +0300
categories: jekyll update
---

Если с кодом и Си не хочется расставаться даже в туалете, специально для тебя есть отличное приложение - бесплатный эмулятор терминала для _Android_, называется **Termux**.
